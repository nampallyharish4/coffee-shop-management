...
-- Insert Categories
INSERT INTO categories (id, name, description) VALUES (1, 'Coffee', 'Hot and cold coffee beverages')
ON DUPLICATE KEY UPDATE name=name;

INSERT INTO categories (id, name, description) VALUES (2, 'Snacks', 'Pastries and snacks')
ON DUPLICATE KEY UPDATE name=name;

INSERT INTO categories (id, name, description) VALUES (3, 'Beverages', 'Non-coffee beverages')
ON DUPLICATE KEY UPDATE name=name;

INSERT INTO categories (id, name, description) VALUES (4, 'Add-ons', 'Extra items and toppings')
ON DUPLICATE KEY UPDATE name=name;

INSERT INTO categories (id, name, description) VALUES (5, 'Seasonal', 'Seasonal specials')
ON DUPLICATE KEY UPDATE name=name;

-- Insert Inventory Items
INSERT INTO inventory_items (id, name, unit, current_stock, reorder_level, created_at, updated_at) 
...
INSERT INTO menu_items (id, name, category_id, price, description, image_url, active, created_at, updated_at) 
...
INSERT INTO menu_ingredients (id, menu_item_id, inventory_item_id, quantity_required) 
VALUES (1, 1, 2, 18.00)
